...
const blogs = [
  ...
  },
  {
    ...
    url: "https://dev.to/abhivarde/my-sync-ui-journey-from-navratri-2024-to-navratri-2025-74j",
  },
  {
    image: IdeaTracker,
    title:
      "🌱 My Idea Tracker Journey with Appwrite (from “Hello World” to Hoodie!)",
    url: "https://dev.to/abhivarde/my-idea-tracker-journey-with-appwrite-from-hello-world-to-hoodie-4p6e",
  },
  {
    image: SyncUIPeerlist,
