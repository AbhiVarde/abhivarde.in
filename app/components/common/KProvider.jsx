      ...
      <KBarProvider actions={actions}>
        <KBarPortal>
          <KBarPositioner className="z-30 backdrop-blur-md backdrop-filter">
            <KBarAnimator className="mx-auto w-[32rem] overflow-hidden rounded-xl border-[1px] border-tertiary bg-white px-4 drop-shadow-2xl ">
              <div className="mx-2 flex items-center justify-between py-4 ">
                <span>
                  <LuSearch className="mr-2 mb-0.5 h-5 w-5" />
                </span>
                <KBarSearch className="w-full rounded-md border-b border-none border-gray-300 outline-none" />
                <div className="bg-gray-300 border bg-opacity-30 px-2 py-0.5 text-sm rounded-md transition duration-200">
                  esc
                </div>
              </div>
              <KResults />
