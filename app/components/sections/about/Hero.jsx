      ...
      <div className="relative overflow-hidden rounded-3xl shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col p-4 sm:p-6">
          <div className="text-white max-w-lg">
            <p className="font-medium uppercase tracking-wider flex items-center text-sm">
              <LuGlobe className="mr-2" size={18} aria-hidden="true" />
              About Me
            </p>
            ...
            <h1 className="mt-3 text-2xl sm:text-3xl font-semibold tracking-tight">
              Hey, I'm Abhi
              <span
                className="animate-wave inline-block ml-2"
                role="img"
          ...
          <div className="mt-auto pt-8 sm:pt-10 max-w-lg">
            <div className="rounded-2xl sm:rounded-3xl p-3 sm:p-4 text-white bg-white/8 border border-white/15">
              <p className="font-normal uppercase tracking-wider flex items-center text-sm">
                <LuRocket className="mr-2" size={18} aria-hidden="true" />
                Highlights
              </p>
