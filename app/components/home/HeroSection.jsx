  ...
  return (
    <div className="pt-10 pb-20 relative overflow-hidden w-full px-4 min-h-[480px]">
      <div className="absolute mx-auto flex flex-col items-center justify-center inset-0 z-0">
        <div className="relative text-xl md:text-2xl lg:text-3xl text-left sm:text-center !leading-9 text-white mb-6">
          <h1>
            Hey, I'm Abhi Varde!
            <span className="animate-wave ml-1.5">👋</span>
          </h1>
          <p className="text-[#FF3B00]">
            Welcome to my corner of the internet!
          </p>
        </div>
        <p className="max-w-xl text-base sm:text-lg text-left sm:text-center text-white">
        ...
        <Link
          href="/about"
          className="mt-8 relative px-4 py-2 bg-[#FF3B00] text-white text-sm font-medium z-10 rounded-lg transition-all duration-200 hover:scale-105 hover:translateZ-0"
        >
          About me
        </Link>
      </div>
