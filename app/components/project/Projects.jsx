  ...
  return (
    <Fragment>
      {projects?.slice(0, 6).map((project, i) => (
        <div
          key={i}
          className={`flex flex-col mt-6 space-y-8 rounded-xl border border-[#333] bg-[#111111] p-4 md:h-48 md:flex-row md:space-y-0 md:space-x-8 ${
            hoveredIndex === i &&
        ...
        >
          ...
          <div className="flex flex-1 flex-col justify-between">
            <div className="flex flex-col space-y-2">
              <h2
                className={`text-lg text-white sm:text-xl font-medium ${
